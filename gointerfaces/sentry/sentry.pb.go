...
type SendMessageByIdRequest struct {
	...
	Data   *OutboundMessageData `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	PeerId *types.H256          `protobuf:"bytes,2,opt,name=peer_id,json=peerId,proto3" json:"peer_id,omitempty"`
}
...
func (x *SendMessageByIdRequest) GetPeerId() *types.H256 {
	if x != nil {
		return x.PeerId
	}
	return nil
...
type SentPeers struct {
	...
	Peers []*types.H256 `protobuf:"bytes,1,rep,name=peers,proto3" json:"peers,omitempty"`
}
...
func (x *SentPeers) GetPeers() []*types.H256 {
	if x != nil {
		return x.Peers
	}
	return nil
...
type PenalizePeerRequest struct {
	...
	PeerId  *types.H256 `protobuf:"bytes,1,opt,name=peer_id,json=peerId,proto3" json:"peer_id,omitempty"`
...
func (x *PenalizePeerRequest) GetPeerId() *types.H256 {
	if x != nil {
		return x.PeerId
	}
	return nil
...
func (x *PeerMinBlockRequest) GetPeerId() *types.H256 {
	if x != nil {
		return x.PeerId
	}
	return nil
...
type InboundMessage struct {
	...
	Id     MessageId   `protobuf:"varint,1,opt,name=id,proto3,enum=sentry.MessageId" json:"id,omitempty"`
	Data   []byte      `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	PeerId *types.H256 `protobuf:"bytes,3,opt,name=peer_id,json=peerId,proto3" json:"peer_id,omitempty"`
}
...
func (x *InboundMessage) GetPeerId() *types.H256 {
	if x != nil {
		return x.PeerId
	}
	return nil
...
func (x *PeersReply) GetPeerId() *types.H256 {
	if x != nil {
		return x.PeerId
	}
	return nil
...
var file_p2psentry_sentry_proto_rawDesc = []byte{
	...
	0x2e, 0x48, 0x32, 0x35, 0x36, 0x52, 0x06, 0x70, 0x65, 0x65, 0x72, 0x49, 0x64, 0x22, 0x6f, 0x0a,
	...
	0x65, 0x73, 0x2e, 0x48, 0x32, 0x35, 0x36, 0x52, 0x05, 0x70, 0x65, 0x65, 0x72, 0x73, 0x22, 0x6a,
	...
	0x32, 0x35, 0x36, 0x52, 0x06, 0x70, 0x65, 0x65, 0x72, 0x49, 0x64, 0x12, 0x2d, 0x0a, 0x07, 0x70,
	...
	0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x48, 0x32, 0x35, 0x36, 0x52, 0x06, 0x70, 0x65, 0x65,
	...
	0x2e, 0x48, 0x32, 0x35, 0x36, 0x52, 0x06, 0x70, 0x65, 0x65, 0x72, 0x49, 0x64, 0x12, 0x32, 0x0a,
...
var file_p2psentry_sentry_proto_depIdxs = []int32{
	...
	21, // 3: sentry.SendMessageByIdRequest.peer_id:type_name -> types.H256
	4,  // 4: sentry.SendMessageToRandomPeersRequest.data:type_name -> sentry.OutboundMessageData
	21, // 5: sentry.SentPeers.peers:type_name -> types.H256
	21, // 6: sentry.PenalizePeerRequest.peer_id:type_name -> types.H256
	1,  // 7: sentry.PenalizePeerRequest.penalty:type_name -> sentry.PenaltyKind
	21, // 8: sentry.PeerMinBlockRequest.peer_id:type_name -> types.H256
	0,  // 9: sentry.InboundMessage.id:type_name -> sentry.MessageId
	21, // 10: sentry.InboundMessage.peer_id:type_name -> types.H256
	...
	21, // 17: sentry.PeersReply.peer_id:type_name -> types.H256
	...
	22, // 22: sentry.Sentry.HandShake:input_type -> google.protobuf.Empty
	...
	22, // 30: sentry.Sentry.NodeInfo:input_type -> google.protobuf.Empty
	14, // 31: sentry.Sentry.SetStatus:output_type -> sentry.SetStatusReply
	22, // 32: sentry.Sentry.PenalizePeer:output_type -> google.protobuf.Empty
	22, // 33: sentry.Sentry.PeerMinBlock:output_type -> google.protobuf.Empty
	...
	23, // 42: sentry.Sentry.NodeInfo:output_type -> types.NodeInfoReply
